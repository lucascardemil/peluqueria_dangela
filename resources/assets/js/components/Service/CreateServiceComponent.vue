                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input v-validate="'required|min:1|max:11'"
                                ...
                                name="score_accumulated" class="form-control" v-model="newService.score_accumulated">
                        ...
                        <div class="form-group">
                            ...
                            <input v-validate="'required|min:1|max:11'"
                                ...
                                name="score_exchange" class="form-control" v-model="newService.score_exchange">
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" v-model="newService.redeemable_service">
