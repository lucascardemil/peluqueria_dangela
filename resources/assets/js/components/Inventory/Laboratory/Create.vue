<template>
    ...
    <form action="POST" v-on:submit.prevent="createLaboratory">
...
export default {
    computed:{
        ...mapState(['newLaboratory', 'errorsLaravel']),
        ...mapGetters(['completeLaboratoryCreate'])
    },
    methods:{
        ...mapActions(['createLaboratory'])
    },
}
</script>
