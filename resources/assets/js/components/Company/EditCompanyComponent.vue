<template>
    ...
    <form action="POST" v-on:submit.prevent="updateCompany({ id: fillCompany.id })">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-warning" :disabled="!completeCompanyEdit">
...
export default {
    computed:{
        ...mapState(['fillCompany', 'errorsLaravel']),
        ...mapGetters(['completeCompanyEdit'])
    },
    methods:{
