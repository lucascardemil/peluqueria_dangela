                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input v-validate="'required|min:8|max:8'" maxlength="8"
                                ...
                                type="text" name="phone" class="form-control form-control-sm" v-model="newClient.phone">
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                type="number" name="score" class="form-control form-control-sm" v-model="newClient.score">
