                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input v-validate="'required|min:7|max:25'"
                                ...
                                class="form-control form-control-sm" v-model="newClient.rut">
                        ...
                        <div class="form-group">
                            ...
                            <input v-validate="'required|min:6|max:190'"
                                ...
                                class="form-control form-control-sm" v-model="newClient.name">
                        ...
                        <div class="form-group">
                            ...
                            <input v-validate="'required|min:6|max:150|email'"
                                ...
                                class="form-control form-control-sm" v-model="newClient.email">
                        ...
                        <div class="form-group">
                            ...
                            <input v-validate="'required|min:6|max:300|'"
                                ...
                                class="form-control form-control-sm" v-model="newClient.city">
                        ...
                        <div class="form-group">
                            ...
                            <input v-validate="'min:8'" :class="{ 'input': true, 'is-invalid': errors.has('phone') }"
                                type="number" name="phone" class="form-control form-control-sm" v-model="newClient.phone">
                        ...
                        <div class="form-group">
                            ...
                            <input v-validate="'required'" :class="{ 'input': true, 'is-invalid': errors.has('birthdate') }"
                                type="date" name="birthdate" class="form-control form-control-sm"
                        ...
                        <div class="form-group">
                            ...
                            <select v-validate="'required'" :class="{ 'input': true, 'is-invalid': errors.has('sex') }"
                                name="sex" class="form-control form-control-sm" v-model="newClient.sex">
                                <option value="1">Masculino</option>
                                <option value="2">Femenino</option>
                                <option value="3">Otro</option>
                            </select>
                            <input v-show="inputOther" :class="{ 'input': true, 'is-invalid': errors.has('otro') }"
                                type="text" name="otro" class="form-control form-control-sm" v-model="newClient.other_sex">
